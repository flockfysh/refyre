...
class Token:
    ...
    '''
    def __init__(self, tab_level, pattern = "", dir = "",  type = "", name = ""):
    ...
    def __repr__(self):
        return f"Token(tab_level={self.tab_level},pattern={self.pattern},directory={self.directory},dirtype={self.dirtype},name={self.name})"
