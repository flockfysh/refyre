...
class FileGraphNode:
    ...
    '''
    def __init__(self, children = [], pattern = "", directory = "", type = "", name = "", is_root = False):
    ...
    def __repr__(self):
        return f"FileGraphNode(children = {self.children}, pattern = {self.pattern}, directory = {self.directory}, type = {self.type}, name = {self.name}, is_root = {self.is_root})"
